...
const isEconIndCommoditiesResponse = (response: AVResponse): response is AVEconIndResponse => (response as AVEconIndResponse).data !== undefined
...
const isExchangeRateResponse = (response: AVResponse): response is CurrencyExchangeResponse => response !== undefined && (response as CurrencyExchangeResponse)["Realtime Currency Exchange Rate"] !== undefined
